...
"base_dic")
  ...
  ;;
"all")
  import_data /opt/soft/datax/job/liyuxin/import/gmall_yuxin_li.order_info.json /2207A/liyuxin/order_info/$do_date
  import_data /opt/soft/datax/job/liyuxin/import/gmall_yuxin_li.base_category1.json /2207A/liyuxin/base_category1/$do_date
  import_data /opt/soft/datax/job/liyuxin/import/gmall_yuxin_li.base_category2.json /2207A/liyuxin/base_category2/$do_date
  import_data /opt/soft/datax/job/liyuxin/import/gmall_yuxin_li.base_category3.json /2207A/liyuxin/base_category3/$do_date
  import_data /opt/soft/datax/job/liyuxin/import/gmall_yuxin_li.order_detail.json /2207A/liyuxin/order_detail/$do_date
  import_data /opt/soft/datax/job/liyuxin/import/gmall_yuxin_li.sku_info.json /2207A/liyuxin/sku_info/$do_date
  import_data /opt/soft/datax/job/liyuxin/import/gmall_yuxin_li.user_info.json /2207A/liyuxin/user_info/$do_date
  import_data /opt/soft/datax/job/liyuxin/import/gmall_yuxin_li.payment_info.json /2207A/liyuxin/payment_info/$do_date
 #新添加
  import_data /opt/soft/datax/job/liyuxin/tms01/import/tms01.order_info.json /2207A/liyuxin/tms01/order_info/$do_date
  import_data /opt/soft/datax/job/liyuxin/tms01/import/tms01.order_cargo.json /2207A/liyuxin/tms/order_cargo/$do_date
  import_data /opt/soft/datax/job/liyuxin/tms01/import/tms01.base_dic.json /2207A/liyuxin/tms/base_dic/$do_date
  import_data /opt/soft/datax/job/liyuxin/tms01/import/tms01.base_complex.json /2207A/liyuxin/tms/base_complex/$do_date
  import_data /opt/soft/datax/job/liyuxin/tms01/import/tms01.base_region_info.json /2207A/liyuxin/tms/base_region_info/$do_date
  import_data /opt/soft/datax/job/liyuxin/tms01/import/tms01.base_organ.json /2207A/liyuxin/tms/base_organ/$do_date
 ;;
esac
